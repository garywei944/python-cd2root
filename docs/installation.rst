...
To install Working Directory Project Root, run this command in your terminal:
...
The sources for Working Directory Project Root can be downloaded from the `Github repo`_.
